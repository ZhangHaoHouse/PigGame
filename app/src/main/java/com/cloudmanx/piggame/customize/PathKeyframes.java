 ...
 * @Description:
 * @Author: zhanghao
 * @Date: 2019/4/23 下午3:49
 */
public class PathKeyframes extends Keyframes {
    ...
    private PointF interpolateInRange(float fracion,int startIndex,int endIndex){
        ...
        float intervalFraction = (fracion - startFraction)/(endFraction - startFraction);

        float startX = mKeyframeData[startBase + X_OFFSET];
        float endX = mKeyframeData[endBase + Y_OFFSET];
